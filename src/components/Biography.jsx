...
const Biography = () => {
  return (
    <section className="h-[100vh] bg-slate-500 xl:h-[70vh] max-w-8xl mx-auto px-4 sm:px-6" id="biography">
      
    <div className="container mx-auto h-full  flex items-center justify-center xl:justify-start">
         
      <div className='w-full items-center justify-center mx-auto'>
       
        <h1 className="uppercase xl:text-[2.5rem]  xs:text-[2.5rem]  font-bold ">Biografia</h1>
        <hr className="w-[1263px] h-[3.5px] bg-white mb-5"  />
         ...
         >
            <p className="xl:text-xl w-full md:text-[1rem]  sm:text-[.9rem] xs:text-[.9rem] ms:text-[.7rem] text-gray-200 text-justify mb-8">
